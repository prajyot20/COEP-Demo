...
public class ProfileFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        username = (TextView) rootView.findViewById(R.id.demo);
        ...
        path = (TextView) rootView.findViewById(R.id.class1);

        username.setText(getActivity().getIntent().getStringExtra("username"));
        password.setText(getActivity().getIntent().getStringExtra("password"));
        lastname.setText(getActivity().getIntent().getStringExtra("lastname"));
        phone.setText(getActivity().getIntent().getStringExtra("phone"));
        email.setText(getActivity().getIntent().getStringExtra("email"));
        path.setText(getActivity().getIntent().getStringExtra("path"));
