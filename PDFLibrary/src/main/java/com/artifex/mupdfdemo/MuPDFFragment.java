...
public class MuPDFFragment extends Fragment implements FilePicker.FilePickerSupport {
    ...
    enum AcceptMode {Highlight, Underline, StrikeOut, Ink, CopyText, Wiki, Translate}
...
//		mMoreButton = (ImageButton)mButtonsView.findViewById(R.id.moreButton);
    ...
    public void OnAcceptButtonClick(View v) {
        ...
        switch (mAcceptMode) {
            case CopyText:
                Log.i("Prajyot", "CopyText");
                Toast.makeText(getActivity(), "Prajyot " + "CopyText", Toast.LENGTH_SHORT).show();
                if (pageView != null)
            ...
            case Wiki:
                Log.i("Prajyot", "Wiki");
                Toast.makeText(getActivity(), "Prajyot " + "Wiki", Toast.LENGTH_SHORT).show();
                if (pageView != null)
                    success = pageView.copySelection();
                mTopBarMode = TopBarMode.More;
                showInfo(success ? getString(R.string.copied_to_clipboard) : getString(R.string.no_text_selected));
            ...
            case Translate:
                ...
                Log.i("Prajyot", "Translate");
                Toast.makeText(getActivity(), "Prajyot " + "Translate", Toast.LENGTH_SHORT).show();
                if (pageView != null)
                    success = pageView.copySelection();
                mTopBarMode = TopBarMode.More;
                showInfo(success ? getString(R.string.copied_to_clipboard) : getString(R.string.no_text_selected));
