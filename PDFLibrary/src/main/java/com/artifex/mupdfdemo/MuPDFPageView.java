...
public class MuPDFPageView extends PageView implements MuPDFView {
    ...
    public boolean copySelection() {
        ...
        if (MuPDFActivity.copySelectionFlag.equals("dict")) {
            ...
            Intent intent = new Intent(new Intent(mContext, WebViewActivity.class).putExtra("url", s.toString()));
            mContext.startActivity(intent);
            ...
            builder.setPositiveButton("Hindi",
                    new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialog, int which) {
                            Intent intent = new Intent(new Intent(mContext, WebViewActivity.class).putExtra("url",
