...
import com.nostra13.universalimageloader.sample.activity.*;
...
public class MuPDFActivity extends Activity implements FilePicker.FilePickerSupport {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        //intentWebView =  new Intent(getApplicationContext(), WebviewActivity1.class);
            ...
            if (Intent.ACTION_VIEW.equals(intent.getAction())) {
                ...
                if (uri.toString().startsWith("content://")) {
                    ...
                    try {
                        ...
                        Toast.makeText(getApplicationContext(), "input stream is : " + is, Toast.LENGTH_LONG).show();
...
*/
    ...
    private void reflowModeSet(boolean reflow) {
        Toast.makeText(this, "This Features is disabled by Prajyot", Toast.LENGTH_SHORT).show();
		/*mReflow = reflow;
...
*/
                        ...
                        Intent intent = new Intent(MuPDFActivity.this, DrawerActivity.class);
                        startActivity(intent);
                        finish();
/*
                        final AlertDialog alert = mAlertBuilder.create();
                        alert.setTitle("MAP Edutech Reader");
                        alert.setMessage("Saving Changes will run in background...");
                        alert.show();
...
*/
    ...
    class ByteArrayTask extends AsyncTask<String,Void,Integer>{
